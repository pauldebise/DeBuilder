...
def _build_plan_prompt(
    ...
    parts.append(
        ...
        "des charges -> implementation + test). Dans le bloc SPEC, "
        "maintiens aussi la ligne de bilan EXACTEMENT au format "
        "« **Couverture : X / N items implementes et testes.** » (X = "
        "nombre d'items realises et valides par test, N = nombre TOTAL "
        "d'items du cahier des charges, constant d'une iteration a "
        "l'autre) : le tableau de bord affiche cette progression.\n"
